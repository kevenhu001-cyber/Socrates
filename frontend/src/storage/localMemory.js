// src/storage/localMemory.js — Phase 1.5 extraction (main.js A.5)
...
export function _memKey(sid){return "socrates-memory-"+(sid||"default")}

export function loadLocalMemory(sid){
  if(!sid)return null;
  try{
...
export function clearLocalMemory(sid){
  if(!sid)return;
