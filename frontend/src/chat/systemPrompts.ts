...
export const PYTHON_RUNNABLE_RULES: string = `
...
export const CHAT_CONCISE_PROMPT: string = `You are a helpful assistant. Answer the user's question directly and concisely.
