var I18N={
  en:{
    ...
    "dialog.task.note":"Tasks run without opening a chat. Voice and connected apps are not used for scheduled runs.",
  ...
  zh:{
    ...
    "dialog.task.note":"任务在后台运行，无需打开对话。定时运行不会使用语音和已连接应用。",
