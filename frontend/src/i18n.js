...
var I18N={
  en:{
    ...
    /* Session-list time buckets (react/session-list/SessionList.tsx) —
       previously hardcoded English in the component. */
    "recents.groupPinned":"Pinned",
    "recents.groupToday":"Today",
    "recents.groupYesterday":"Yesterday",
    "recents.groupPrev7":"Previous 7 days",
    "recents.groupPrev30":"Previous 30 days",
    "recents.month.1":"January",
    "recents.month.2":"February",
    "recents.month.3":"March",
    "recents.month.4":"April",
    "recents.month.5":"May",
    "recents.month.6":"June",
    "recents.month.7":"July",
    "recents.month.8":"August",
    "recents.month.9":"September",
    "recents.month.10":"October",
    "recents.month.11":"November",
    "recents.month.12":"December",
    "session.untitled":"(untitled)",
    /* Relative-time + row-meta strings — previously hardcoded English in
       sessionList.bridge.ts (formatRelativeTime) and SessionList.tsx
       (buildMeta). The English fallbacks are byte-identical to the old
       literals; {n} is substituted at the call site (web t() does not
       interpolate). */
    "session.timeJustNow":"Just now",
    "session.timeMinutesAgo":"{n}m ago",
    "session.timeHoursAgo":"{n}h ago",
    "session.timeDaysAgo":"{n}d ago",
    "session.timeWeeksAgo":"{n}w ago",
    "session.timeMonthsAgo":"{n}mo ago",
    "session.metaQuestions":"{n} Qs",
    "session.metaReExplained":"Re-explained",
    "session.metaBranched":"Branched",
    ...
    "toast.toolsFallback":"This model's API doesn't support native tool calls — answered in text only",
    "msg.readAloud":"Read aloud",
    /* Message toolbar (react/message-list/MessageToolbar.tsx) — the
       English fallbacks must stay byte-identical to the pre-i18n
       strings: e2e/message-list-compat selects by aria-label. */
    "msg.copy":"Copy",
    "msg.edit":"Edit message",
    "msg.delete":"Delete message",
    "msg.share":"Share conversation",
    "msg.regenerate":"Regenerate response",
    "msg.thumbsUp":"Helpful",
    "msg.thumbsDown":"Not helpful",
    "msg.branch":"Branch from here",
    "msg.reExplain":"Re-explain from a different angle",
    ...
    "tool.generatedFiles":"Generated files",
    "tool.file":"File",
    "tool.openFile":"Open",
    "tool.downloadFile":"Download",
  ...
  zh:{
    ...
    "home.explore.hint":"滑动探索",
    "sidebar.nav.kbd":"Ctrl K",
    "sidebar.nav.new":"新聊天",
    ...
    "recents.groupPinned":"置顶",
    "recents.groupToday":"今天",
    "recents.groupYesterday":"昨天",
    "recents.groupPrev7":"最近 7 天",
    "recents.groupPrev30":"最近 30 天",
    "recents.month.1":"一月",
    "recents.month.2":"二月",
    "recents.month.3":"三月",
    "recents.month.4":"四月",
    ...
    "recents.month.9":"九月",
    "recents.month.10":"十月",
    "recents.month.11":"十一月",
    "recents.month.12":"十二月",
    "session.untitled":"（未命名）",
    "session.timeJustNow":"刚刚",
    "session.timeMinutesAgo":"{n} 分钟前",
    "session.timeHoursAgo":"{n} 小时前",
    "session.timeDaysAgo":"{n} 天前",
    "session.timeWeeksAgo":"{n} 周前",
    "session.timeMonthsAgo":"{n} 个月前",
    "session.metaQuestions":"{n} 问",
    "session.metaReExplained":"已重新讲解",
    "session.metaBranched":"已分叉",
    ...
    "scheduled.subtitle":"让 Socrates 帮你安排任务、设置提醒，或跟踪更新。",
    "scheduled.inputPlaceholder":"安排任务",
    "scheduled.recommendations":"推荐",
    ...
    "scheduled.allTasks":"活动",
    "scheduled.activeOnly":"进行中",
    "scheduled.yourTasks":"你的任务",
    "scheduled.noActive":"没有进行中的任务",
    ...
    "plugins.allPlugins":"全部插件",
    "plugins.search":"搜索插件",
    "plugins.noMatch":"没有匹配的插件",
    "plugins.tryDifferent":"换个关键词试试。",
    "plugins.installedEmpty":"还没有安装插件",
    "plugins.installedEmptyDesc":"连接的应用会出现在这里。",
    "plugins.browseAll":"浏览全部插件",
    "plugins.oauthNote":"OAuth 令牌仅保存在 OOMOL 网关，浏览器和模型都不会接触到提供方令牌。",
    "plugins.directoryDesc":"在你常用的工具中与 Socrates 协作。",
    "plugins.public":"公开",
    "plugins.personal":"个人",
    "plugins.popular":"热门",
    "plugins.new":"新品推荐",
    "plugins.manage":"管理",
    "plugins.manageDialog.status":"状态",
    "plugins.manageDialog.account":"账号",
    "plugins.manageDialog.updated":"更新时间",
    "plugins.manageDialog.error":"最近错误",
    "plugins.manageDialog.refresh":"刷新",
    "plugins.manageDialog.disconnect":"断开连接",
    "home.reviewProject":"复习一个学习项目",
    "home.browseMaterials":"浏览笔记和资料",
    "home.connectApp":"连接应用到当前对话",
    ...
    "home.quick.upload":"添加图片或文件",
    "home.quick.write":"撰写或编辑",
    "home.quick.research":"搜索网页",
    ...
    "effort.low":"低",
    "chatconfig.title":"配置",
    "chatconfig.models":"模型",
    "chatconfig.model":"模型",
    "chatconfig.noModels":"还没有可用模型",
    "chatconfig.effort":"思考强度",
    "chatconfig.speed":"速度",
    "chatconfig.speed.standard":"标准",
    "chatconfig.speed.fast":"快速",
    "chatconfig.speed.standardHint":"兼容所有已配置模型",
    "chatconfig.speed.fastHint":"优先使用低延迟服务，不支持时自动降级",
    "chatconfig.manageModels":"管理模型",
    "toast.speedFallback":"当前模型不支持快速模式，已使用标准速度",
    "toast.toolsFallback":"当前模型接口不支持原生工具调用，本轮已退回纯文本回答",
    "msg.readAloud":"朗读",
    "msg.copy":"复制",
    "msg.edit":"编辑消息",
    "msg.delete":"删除消息",
    ...
    "tool.actionInitWorkspace":"正在初始化工作区…",
    "tool.doneInitWorkspace":"工作区已就绪",
    ...
    "tool.result":"结果",
    "tool.sources":"来源",
    "tool.generatedFiles":"生成的文件",
    "tool.file":"文件",
    "tool.openFile":"打开",
    "tool.downloadFile":"下载",
