...
var I18N={
  ...
  zh:{
    ...
    "greeting.chat":"今天有什么计划？",
    "greeting.tutor":"来一起探索吧",
    /* Rotating landing greeting — renderGreeting picks one entry per open. */
    "greeting.chat.0":"今天有什么计划？",
    "greeting.chat.1":"想做点什么？",
    "greeting.chat.2":"在想什么？",
    "greeting.chat.3":"我们从哪里开始？",
    "greeting.chat.4":"准备好了就开始。",
    "greeting.chat.5":"想聊点什么？",
    "greeting.chat.6":"有什么我能帮忙的？",
    "greeting.chat.7":"开始吧。",
    "greeting.tutor.0":"来一起探索吧",
    "greeting.tutor.1":"今天想弄明白什么？",
    "greeting.tutor.2":"对什么好奇？",
    "greeting.tutor.3":"我们一起来想想。",
    "greeting.tutor.4":"想理解什么？",
    "greeting.tutor.5":"准备好提问了吗？",
    /* Composer "+" menu. */
    ...
    "composer.tools.createImage":"创建图像",
    "composer.createImage.hint":"描述你想生成的图像",
    "composer.createImage.connectRequired":"请先在插件页连接即梦 AI，再创建图像。",
    "composer.tools.createSite":"创建站点",
    "composer.createSite.hint":"描述你想创建并发布的页面",
    "composer.tools.plugins":"插件",
    "composer.tools.thinkDeeper":"更深入思考",
    "composer.tools.group.context":"添加资料",
    "composer.tools.group.research":"搜索与研究",
    "composer.tools.group.create":"创作与分析",
    "composer.tools.connectedApps":"已连接应用",
    "composer.tools.searchFooter":"搜索工具和已连接应用",
    "composer.tools.noMatch":"没有匹配的操作。",
    "composer.tools.plugins.loading":"正在加载已连接应用…",
    "composer.tools.plugins.error":"已连接应用加载失败。",
    "composer.tools.plugins.retry":"重试",
    "composer.tools.plugins.empty":"还没有已连接应用。",
    "composer.tools.plugins.emptyHint":"连接应用后，可将相关内容添加到对话。",
    "composer.tools.plugins.noMatch":"没有匹配的已连接应用。",
    "composer.tools.plugins.manage":"管理应用",
    "composer.tools.webSearchHint":"搜索网页上的最新信息",
    ...
    "sidebar.nav.images":"图片",
    "sidebar.nav.assistants":"助手",
    "sidebar.nav.sites":"站点",
    "sidebar.nav.skills":"技能",
    "sidebar.nav.newBadge":"新",
    "sidebar.nav.exam":"考试",
    ...
    "sidebar.account.profile":"个人资料",
    "sidebar.account.settings":"设置",
    "library.filter.images":"图片",
    "library.emptyImages":"还没有图片",
    "library.emptyImagesDesc":"添加的图片会显示在这里。",
    ...
    "profile.archivedSessionsDesc":"归档的会话保留 30 天。可在「最近」行操作中归档，再在此恢复或永久删除。",
    "profile.manage":"管理",
    ...
    "session.ctxArchive":"归档",
    "session.archived":"会话已归档",
    "session.archiveFailed":"归档失败：{msg}",
    ...
    "session.archiveFirst":"请先在「最近」中归档该会话。",
