var I18N={
  en:{
    ...
    "agent.modeShort":"Agent",
    "agent.modeOn":"Agent on: this turn runs in the workspace agent",
    "agent.modeOff":"Turn on Agent: let the workspace agent do the work",
  ...
  zh:{
    ...
    "agent.elapsed":"用时",
    "agent.modeShort":"Agent",
    "agent.modeOn":"已开启 Agent：本轮交给工作区代理",
    "agent.modeOff":"开启 Agent：让工作区代理执行任务",
