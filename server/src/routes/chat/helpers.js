...
export async function prependTeacherModePrompt(messages) {
...
export function injectUserContext(messages, user) {
...
export async function checkBeagleMonthlyLimit(userId, tier) {
...
export function transformContentForModel(content, multimodal) {
...
export function transformMessagesForModel(messages, provider) {
...
export async function prepareChatRequest(req, res) {
  let parsed;
  try {
...
export function chatRateLimitDispatch(req, res, next) {
