...
import { UNIFIED_CODEX_ENABLED, INITIALIZE_WORKSPACE_TOOL, WORKSPACE_AGENT_TOOL } from './agentRuntime.js';
...
export function createToolRegistry({ codeInterpreterToolDef, mode, connectorConnectionsByProvider, projectConnectorConnectionsByProvider }: {
  ...
  const entries = [
    ...
    { name: 'initialize_workspace', modelDefinition: INITIALIZE_WORKSPACE_TOOL, enabled: UNIFIED_CODEX_ENABLED, pure: false, sessionSerial: true, maxConcurrency: 1, retries: 0 },
