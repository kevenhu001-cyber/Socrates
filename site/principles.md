...
These principles guide the trade-offs we make while building Socrates. They are written in plain language and updated when our view changes.

## 1. Questions over performance
...
## How we hold to these principles

- We say no to feature requests that would push the tutor toward longer answers at the cost of deeper engagement.
- We say no to telemetry that would let us correlate a session with an outcome if the user has not opted in.
- We say yes to partnerships that share our view of what learning looks like.
